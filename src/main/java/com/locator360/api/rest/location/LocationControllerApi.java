...
public interface LocationControllerApi {
    ...
    @Operation(summary = "Obter localização de todos os membros do círculo",
            description = "Retorna a última localização conhecida de cada membro ativo que está compartilhando localização")
    @ApiResponses({
